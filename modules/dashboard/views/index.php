							...
							<div class="card-p mt-n20 position-relative">
								...
								<div class="row g-0">
									...
									<div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
										...
										<!--end::Svg Icon-->
										<a href="<?=site_url('project')?>" class="text-warning fw-bold fs-6">Project</a>
									</div>
									<!--end::Col-->
									<!--begin::Col-->
									<div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
										...
										<!--end::Svg Icon-->
										<a href="<?=site_url('kontak')?>" class="text-primary fw-bold fs-6">Kontak</a>
									</div>
									<!--end::Col-->
								</div>
								<!--end::Row-->
								...
								<div class="row g-0">
									...
									<div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
										...
										<!--end::Svg Icon-->
										<a href="<?=site_url('blog')?>" class="text-danger fw-bold fs-6 mt-2">Blog</a>
									</div>
									<!--end::Col-->
									<!--begin::Col-->
									<div class="col bg-light-success px-6 py-8 rounded-2">
										...
										<!--end::Svg Icon-->
										<a href="<?=site_url('kategori_project')?>" class="text-success fw-bold fs-6 mt-2">Kategori Project</a>
									</div>
									<!--end::Col-->
								</div>
								<!--end::Row-->
