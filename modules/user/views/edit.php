		...
		<div id="kt_content_container" class="container">
			<div class="card shadow-sm" id="card">
				...
				<div class="card-header">
					...
					<input type="hidden" name="id_user" id="id_user" value="<?=$result->id_user?>">
				...
				<div class="card-body">
					...
					<div class="row mb-3">
						<label for="alamat" class="col-sm-2 col-12 col-form-label">Alamat </label>
						<!--end::Label-->
						<div class="col-sm-10 col-12">
							<textarea name="alamat" id="alamat" class="form-control"><?=$result->alamat?></textarea>
						</div>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-10 col-12">
							<select name="tipe" id="tipe" class="form-select form-select-sm " data-control="select2">
								...
								<option value="1" <?=($result->tipe == '1') ? 'selected': ''?>>Superadmin</option>
								<option value="2" <?=($result->tipe == '2') ? 'selected' : ''?>>Admin</option>
							</select>
						</div>
					</div>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-10 col-12">
							<select name="aktif" id="aktif" class="form-select form-select-sm " data-control="select2">
								<option value="1" <?=($result->aktif == '1') ? 'selected' : ''?>>Aktif</option>
								<option value="0" <?=($result->aktif == '0') ? 'selected' : ''?>>Non Aktif</option>
							</select>
						</div>
					</div>
					...
					<div class="row mb-3">
						<!--begin::Label-->
						<label for="gender" class="col-sm-2 col-12 col-form-label">
						...
						<div class="col-sm-10 col-12">
							<div class="image-input image-input-outline " data-kt-image-input="true" style="background-image: url(<?=base_url('assets/dist/assets/media/avatars/blank.png')?>);">
									 ...
									 <?php 
									 if ($result->foto != '' && file_exists($data_path.'user/'.$result->foto)){
										$encimg = setencrypt($data_path.'user/'.$result->foto);
										$imgurl = site_url('media/image_access_profile/'.$encimg);
									 }else{
										$imgurl = site_url('media/no_image');
									 }
									 ?>
								     <div class="image-input-wrapper w-125px h-125px" style="background-image: url(<?=$imgurl?>)"></div>
					...
					<div class="row mb-3">
						<label for="password" class="col-sm-2 col-12 col-form-label">Kata Sandi </label>
						<!--end::Label-->
						<div class="col-sm-10 col-12">
					...
					<div class="row mb-3">
						<label for="repassword" class="col-sm-2 col-12 col-form-label">Ulang Kata Sandi </label>
						<!--end::Label-->
						<div class="col-sm-10 col-12">
