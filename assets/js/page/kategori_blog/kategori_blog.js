...
jQuery(document).ready(function(){
 ...
 var t = $('#kt_table_kategori_blog').DataTable( {
        "columnDefs": [ {
            "searchable": false,
            "orderable": false,
            "targets": [0,1,2]
...
t.on( 'order.dt search.dt', function () {
    ...
    $("#kt_table_kategori_blog").on('click', '.checkboxes', function(){
        var table = $('#kt_table_kategori_blog').DataTable();
...
userdeleteModal.addEventListener('show.bs.modal', function (event){
    ...
    var id_kategori = button.getAttribute('data-bs-id_blog_kategori')
    ...
    $("#btn_delete_confirm").on('click', function(respdata){
        ...
        $.post(url + 'delete', {id_blog_kategori: id_kategori}, function(respond){
