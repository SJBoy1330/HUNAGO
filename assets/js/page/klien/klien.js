...
jQuery(document).ready(function(){
 ...
 var t = $('#kt_table_klien').DataTable( {
        "columnDefs": [ {
            "searchable": false,
            "orderable": false,
            "targets": [0,1,2]
...
t.on( 'order.dt search.dt', function () {
    ...
    $("#kt_table_klien").on('click', '.checkboxes', function(){
        var table = $('#kt_table_klien').DataTable();
...
userdeleteModal.addEventListener('show.bs.modal', function (event){
    ...
    var id_klien = button.getAttribute('data-bs-id_klien')
