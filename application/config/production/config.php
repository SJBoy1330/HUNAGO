...
$config['data_path'] = APPPATH.'../../hunago.com/data/';
$config['main_url'] = 'https://hunago.com/data/';
// $config['base_url'] = 'http://localhost/managerruvy';
// $config['data_url'] = 'http://localhost/data/';
